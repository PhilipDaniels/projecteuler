...
mod tests {
    ...
    fn make_from_for_two_dimensional_string_returns_correct_vector() {
        let m = Matrix::<i32>::make_from_string("10 20 30\n40 50 60\n70 80 90").unwrap();
        assert_eq!(m.rows(), 3);
        assert_eq!(m.cols(), 3);
    ...
    #[test]
    fn make_from_string_for_string_containing_different_numbers_of_cols_returns_err() {
        let m = Matrix::<i32>::make_from_string("10\n20 30");
